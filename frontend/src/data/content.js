...
export const portfolios = [
  {
    ...
    category: "website",
    description: "Web-based POS (Point of Sale) and warehouse management system for a wholesale business, built with Laravel and React.",
  ...
  },
  {
    ...
    category: "website",
    description: "Company ERP web application — an integrated management system built with React, Vite, and Supabase.",
  ...
  },
  {
    ...
    title: "Tuku-Tiket",
    category: "website",
    description: "Event ticket booking web app, built with React and Supabase.",
  ...
  },
  {
    ...
    category: "website",
    description: "Inventory management web app, built with React and Supabase.",
